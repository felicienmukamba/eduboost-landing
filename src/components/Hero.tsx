                ...
                <div className="grid gap-16 lg:grid-cols-2 lg:gap-12 items-center">
                    ...
                    <div ref={textRef} className="flex flex-col justify-center text-center lg:text-left space-y-8 z-20">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <Button disabled size="lg" className="rounded-full h-14 px-8 text-base shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all hover:scale-105">
                            ...
                            <Button disabled size="lg" variant="outline" className="rounded-full h-14 px-8 text-base border-2 hover:bg-muted/50 transition-all hover:scale-105">
